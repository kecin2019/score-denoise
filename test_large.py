...
parser.add_argument(
    "--input_xyz", type=str, default="./data/soybean/nannong53_2_clean.xyz"
)
parser.add_argument(
    "--output_xyz",
    type=str,
    default="./data/soybean/nannong53_2_clean_denoised.xyz",
)
...
pcl_denoised = denoise_large_pointcloud(
    model=model, pcl=pcl, cluster_size=args.cluster_size, seed=args.seed
)
